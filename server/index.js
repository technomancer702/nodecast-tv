...
// Trust the first proxy hop (nginx, Caddy, etc.) for X-Forwarded-For / X-Forwarded-Proto.
// Using 1 instead of true so express-rate-limit can safely use the client IP.
